...
* [Помощь сообществу](#contribution)
...
# <a name="contribution"></a>Помощь сообществу

Ввиду того что данное руководство создаётся на общественных началах, любой вклад в его развитие крайне приветствуется.
Например, вы можете заняться секцией "Тестирование" или переводом всего документа на ваш язык.
